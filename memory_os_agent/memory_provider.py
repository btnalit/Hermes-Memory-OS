...
Kept synchronized with agent.memory_provider.MemoryProvider (host ABC).
When Hermes agent is installed, the conditional import in __init__.py
resolves to the host ABC; this file is the ImportError fallback.
"""
