...
def test_active_closure_profile_installs_eight_hermes_cron_jobs():
    """The point of the consolidation: 23 lanes -> 8 Hermes jobs.
    ...
    and +state_source_mirror registered on 2026-08-06; +memory_projection_
    compaction registered 2026-09-23 (all three ride existing ticks — the
    8-job invariant is the one that must never move silently).
    """
