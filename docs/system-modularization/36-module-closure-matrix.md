...
| P1-T | Cron / Session / State Mirrors; Household Digest; Wandering Mind; Speak Gate; Evidence Scoring; Self-Evolution; Governance Feedback; DeepReflection; Owner Review Hermes Cron Helper | | Prototype-aligned cadence split must keep Hermes as scheduler/delivery owner while Memory-OS exposes bounded module generated/skipped/error/duplicate evidence. Runtime splits now cover SelfEvolution, EvidenceScoring, OpsGate, and DeepReflection module-local skip gates; they are not Memory-OS timer or transport changes. |
