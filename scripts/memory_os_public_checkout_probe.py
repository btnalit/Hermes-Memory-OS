...
REQUIRED_PUBLIC_FILES = (
    ...
    "docs/contracts/memory-os-closure-matrix.v1.json",
    "docs/quickstart.md",
    ...
    "scripts/memory_os_mount_isolated_pytest.py",
    "scripts/memory_os_pytest_policy.py",
    ...
    "plugins/memory/memory_os/operational_truth.py",
    ...
    "tests/scripts/test_memory_os_github_ci.py",
    "tests/scripts/test_memory_os_mount_isolated_pytest.py",
