...
class CognitiveLoopRunner:
    ...
    def _provisional(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        # V2-0: report-only eligibility; no automatic permanent promotion.
        from plugins.memory.memory_os.crystallized import CrystallizedMemoryService
        eligibility_report = CrystallizedMemoryService(self.store).collect_permanent_promotion_eligibility(dry_run=True)
        ...
        result = {
            ...
            "auto_promote_checked": int(eligibility_report.get("eligible_count", 0) or 0),
            "auto_promote_promoted": 0,
            "actual_send": False,
            "actual_execute": False,
            "actual_crystallized_approval": False,
            "canonical_state_changed": False,
    ...
    def _structural_edge_proposer(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "backfill_outcome": result.get("backfill_outcome", ""),
