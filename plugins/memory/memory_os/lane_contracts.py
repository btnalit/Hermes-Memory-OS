...
_CRON_LANE_CONTRACTS: dict[str, LaneContract] = {
    ...
    "fact_judge": LaneContract(
        ...
        consumers=("plugins.memory.memory_os.crystallized",),
        monitor_codes=GENERIC_CRON_LANE_MONITOR_CODES + ("llm_lane_consecutive_failure_streak",),
    ),
    ...
    "session_fact_extraction": LaneContract(
        ...
        consumers=("plugins.memory.memory_os.crystallized",),
        monitor_codes=GENERIC_CRON_LANE_MONITOR_CODES + ("lane_input_stale", "llm_lane_consecutive_failure_streak"),
    ),
    ...
    "memory_projection_compaction": LaneContract(
        ...
        disposition="report_only",
        monitor_codes=GENERIC_CRON_LANE_MONITOR_CODES + ("memory_projection_retention_compaction_missing",),
    ),
